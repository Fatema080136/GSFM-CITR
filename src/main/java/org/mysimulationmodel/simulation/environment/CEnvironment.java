...
public class CEnvironment extends JPanel implements IEnvironment
{
    ...
    public CEnvironment()
    {
       ...
       setDoubleBuffered( true );
        ...
        m_width = 120*m_pixelpermeter;//600;//x axis
        m_height =60*m_pixelpermeter; //400;//y axis
    }
    ...
    private void drawPedestrian()
    {
        ...
        m_pedestrian
                .forEach( i -> {
                    Ellipse2D.Double shape = new Ellipse2D.Double( i.getPosition().getX(), i.getPosition().getY(), 0.5*m_pixelpermeter, 0.5*m_pixelpermeter );//2.5//8
    ...
    private void drawCar()
    {
        ...
        m_car
                .forEach( i -> {
                    ...
                    graphics2d.fillRect( (int)(i.getPosition().x -1.1*m_pixelpermeter ), (int)(i.getPosition().y -0.55*m_pixelpermeter), (int)2.2*m_pixelpermeter, (int)(1.1*m_pixelpermeter) );//20,10//16, 8
