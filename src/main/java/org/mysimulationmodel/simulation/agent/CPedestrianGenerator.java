...
public final class CPedestrianGenerator extends IBaseAgentGenerator<IBaseRoadUser>
{
    ...
    private static final double m_GaussianStandardDeviationMaxSpeed = 0.25;//*m_pixelpermeter;//0.435: meter per half second
    */
    ...
    public final IBaseRoadUser generatesingle( @Nullable final Object... p_data )
    {
        ...
        l_pedestrian.setPedClass(l_ped.m_pedtype);

        if(l_ped.m_pedtype == 0)
        {
            // to var
            //l_pedestrian.updateParameter(0.18*m_pixelpermeter, 0.69*m_pixelpermeter, 7.0*m_pixelpermeter, 0.5,
              //  0.1*m_pixelpermeter, 6.1*m_pixelpermeter, 7.0*m_pixelpermeter, 8*m_pixelpermeter);

            // without pca
            l_pedestrian.updateParameter(0.1*m_pixelpermeter, 1.5*m_pixelpermeter, 6.1*m_pixelpermeter,
                   0.15, 0.2*m_pixelpermeter, 0.9*m_pixelpermeter,6.1*m_pixelpermeter, 8*m_pixelpermeter);
            //pca
            //l_pedestrian.updateParameter(0.19*m_pixelpermeter, 0.68*m_pixelpermeter, 6.87*m_pixelpermeter, 0.17, 0.11*m_pixelpermeter, 6.1*m_pixelpermeter,6.87*m_pixelpermeter, 8*m_pixelpermeter);

        }
        else if (l_ped.m_pedtype == 1)
        {
            // two var
            //l_pedestrian.updateParameter(0.18*m_pixelpermeter, 0.69*m_pixelpermeter, 7.0*m_pixelpermeter, 0.3,
              //    0.1*m_pixelpermeter, 6.1*m_pixelpermeter, 7.0*m_pixelpermeter, 8*m_pixelpermeter);
            // without pca
            l_pedestrian.updateParameter(0.2*m_pixelpermeter, 0.39*m_pixelpermeter, 8.4*m_pixelpermeter, 0.59,
                   0.1*m_pixelpermeter, 10.5*m_pixelpermeter, 8.4*m_pixelpermeter, 8*m_pixelpermeter);
            //pca
            //l_pedestrian.updateParameter(0.30000000000000004*m_pixelpermeter, 0.61*m_pixelpermeter, 7.3*m_pixelpermeter, 0.37, 0.1*m_pixelpermeter,
              //     6.1*m_pixelpermeter,7.3*m_pixelpermeter, 8*m_pixelpermeter);
        ...
        {
            // two var
            //l_pedestrian.updateParameter(0.18*m_pixelpermeter, 0.69*m_pixelpermeter, 7.0*m_pixelpermeter,
              //     0.33, 0.5*m_pixelpermeter, 6.1*m_pixelpermeter, 7.0*m_pixelpermeter, 8*m_pixelpermeter);
            // without pca
            l_pedestrian.updateParameter(0.25*m_pixelpermeter, 1.1*m_pixelpermeter, 8.3*m_pixelpermeter, 0.52,
                  0.4*m_pixelpermeter, 0.3*m_pixelpermeter, 8.3*m_pixelpermeter, 8*m_pixelpermeter);
            //pca
            //l_pedestrian.updateParameter(0.1*m_pixelpermeter, 3*m_pixelpermeter, 4.9*m_pixelpermeter, 0.53, 0.4*m_pixelpermeter,
              //     0.3*m_pixelpermeter,4.9*m_pixelpermeter, 8*m_pixelpermeter);
        }
        //universal parameters values
        //l_pedestrian.updateParameter(0.18*m_pixelpermeter, 0.69*m_pixelpermeter, 7.0*m_pixelpermeter, 0.13,
          //  0.1*m_pixelpermeter, 6.1*m_pixelpermeter, 7.0*m_pixelpermeter, 8*m_pixelpermeter);

        l_pedestrian.setmaxforce( 2*m_pixelpermeter );
